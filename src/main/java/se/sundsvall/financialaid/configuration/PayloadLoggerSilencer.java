package se.sundsvall.financialaid.configuration;
 ...
 * logging that would otherwise leak sensitive data. Registered via {@code META-INF/spring.factories} so it outranks
 * dept44's
...
public class PayloadLoggerSilencer implements EnvironmentPostProcessor {
	...
	private static final String PROPERTY_SOURCE_NAME = "financialAidPayloadLoggerOverride";
